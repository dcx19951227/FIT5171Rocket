...
public class RocketUnitTest {
    ...
    @DisplayName("should create rocket successfully when given right name to constructor")
    @Test
    public void shoulThrowExceptionWhenNameNull() {
        String name = "BFR";
        String country = "USA";
        LaunchServiceProvider manufacturer = new LaunchServiceProvider("SpaceX", 2002, "USA");
        Rocket bfr = new Rocket(name, country, manufacturer);
        NullPointerException exception = assertThrows(NullPointerException.class, () -> bfr.setName(null));
        assertEquals("name cannot be null or empty", exception.getMessage());
    }

    @DisplayName("should throw exception when given null to country attribute")
    @Test
    public void shoulThrowExceptionWhenCountryNull() {
        String name = "BFR";
        String country = "USA";
        LaunchServiceProvider manufacturer = new LaunchServiceProvider("SpaceX", 2002, "USA");
        Rocket bfr = new Rocket(name, country, manufacturer);
        NullPointerException exception = assertThrows(NullPointerException.class, () -> bfr.setCountry(null));
