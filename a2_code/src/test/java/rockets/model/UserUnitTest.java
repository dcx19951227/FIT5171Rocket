...
public class UserUnitTest {
    ...
    @DisplayName("should have valid email address format")
    @Test
    public void shouldHaveValidAddress(){
        String email = "123@wrong.com";
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> target.setEmail(email));
        assertEquals("email in wrong format", exception.getMessage());
    }
}